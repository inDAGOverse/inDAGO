            ...
            bslib::accordion_panel(
              ...
              shiny::fluidRow(shiny::column(
                width = 12, shiny::splitLayout(
                  ...
                  bslib::tooltip(
                    bsicons::bs_icon("question-circle"),
                    "Define the minimum read length threshold. Reads equal to or exceeding this threshold will be retained for further analysis. '75' by default.",
                    placement = "right"
                  )
                )
              )),
...
each sub-sample to be processed. '10^6' by default .",
        ...
        shinyWidgets::dropdownButton(inputId = shiny::NS(id,
          "Info filtering"),
          status = "info",
          label = "Info",
          size = "sm",
          circle = FALSE,
          htmltools::h3(shiny::strong("Filtering Process")),
          htmltools::br(),

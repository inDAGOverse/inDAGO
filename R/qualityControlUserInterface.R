...
qualityControlUserInterface <- function(id) {
  ...
  bslib::layout_sidebar(
        ...
        ## BASIC OPERATION ACCORDION PANEL
          bslib::accordion_panel(
            ...
            shiny::fluidRow(shiny::column(width = 12, shiny::splitLayout(cellWidths = c("90%", "10%"),
                            ...
                            shiny::verbatimTextOutput(nsQuality("QualityPathInputDir")),
            )), # close fluidRow
            htmltools::br(),
            ## result folder
            shiny::fluidRow(shiny::column(width = 12, shiny::splitLayout(cellWidths = c("90%", "10%"),
            ...
            shiny::verbatimTextOutput(nsQuality("QualityPathOutputDir")),
            )), # close fluidrow
    ...
    bslib::accordion(
      ...
      shiny::verbatimTextOutput(nsQuality("mainProcessStatus")),
      ## CONDITIONAL PANELS
